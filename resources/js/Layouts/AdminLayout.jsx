                    ...
                    {auth.user.role === 'pengawas' && (
                        <Link 
                            ...
                            style={{ 
                                ...
                                alignItems: 'center',
                                gap: '12px',
                                backgroundColor: route().current('admin.audit-logs.*') ? 'rgba(255, 255, 255, 0.1)' : 'transparent',
                                color: route().current('admin.audit-logs.*') ? 'var(--color-on-dark)' : 'rgba(255, 255, 255, 0.7)',
                                fontWeight: route().current('admin.audit-logs.*') ? 600 : 500,
                                transition: 'all 0.2s ease'
                            }}
                            onClick={() => setIsSidebarOpen(false)}
                        >
